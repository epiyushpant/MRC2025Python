...
# this is multiline string used for SQL query, it allows us
# to write the query in a more readable format without needing to
# concatenate strings or use newline characters. 
...
def create_student(first, last, email, grade, major):
    ...
    connection_obj.commit() #to permanently save the changes to the database
